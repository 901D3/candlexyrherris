...
gId("fftSizeRange").addEventListener("input", function () {
  ...
  getWindowFunction(fftSize, gId("windowFuncInput").value);

  stftRe = new Float32Array(fftSize);
...
gId("postVolumeMultiplierRange").addEventListener("input", function () {
  sliderInputSync(
    gId("postVolumeMultiplierRange"),
    gId("postVolumeMultiplierInput"),
    "postVolMultiply",
    undefined,
    "slider"
  );
...
gId("amplitudeOffsetRange").addEventListener("input", function () {
  sliderInputSync(
    gId("amplitudeOffsetRange"),
    gId("amplitudeOffsetInput"),
    "amplitudeOffset",
    undefined,
    "slider"
  );
...
gId("minAmplitudeRange").addEventListener("input", function () {
  sliderInputSync(
    gId("minAmplitudeRange"),
    gId("minAmplitudeInput"),
    "minAmplitude",
    undefined,
    "slider"
  );
...
gId("maxAmplitudeRange").addEventListener("input", function () {
  sliderInputSync(
    gId("maxAmplitudeRange"),
    gId("maxAmplitudeInput"),
    "maxAmplitude",
    undefined,
    "slider"
  );
...
gId("barStyle").addEventListener("change", function () {
  ...
  const barStyleControls = {
    ...
    oval: [],
    lines: [],
    peaks: ["triangCapsuleSettingsDisp"],
  };
...
gId("barColorRedRange").addEventListener("input", function () {
  sliderInputSync(
    gId("barColorRedRange"),
    gId("barColorRedInput"),
    "barColorRed",
    undefined,
    "slider"
  );
...
gId("barColorGreenRange").addEventListener("input", function () {
  sliderInputSync(
    gId("barColorGreenRange"),
    gId("barColorGreenInput"),
    "barColorGreen",
    undefined,
    "slider"
  );
...
gId("barColorBlueRange").addEventListener("input", function () {
  sliderInputSync(
    gId("barColorBlueRange"),
    gId("barColorBlueInput"),
    "barColorBlue",
    undefined,
    "slider"
  );
...
gId("backgroundColorRedRange").addEventListener("input", function () {
  sliderInputSync(
    gId("backgroundColorRedRange"),
    gId("backgroundColorRedInput"),
    "backgroundColorRed",
    undefined,
    "slider"
  );
...
(function () {
  ...
  sliderInputSync(
    gId("recorderFrameRateRange"),
    gId("recorderFrameRateInput"),
    "recorderFrameRate",
    null,
    "input"
  );
