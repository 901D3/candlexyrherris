//Unofficial aurora.js used in audiocogs's demos
  ...
  return (function e(t, n, r) {
              ...
              AVBuffer = (function () {
                ...
                function AVBuffer(input) {
                  ...
                  if (input instanceof Uint8Array) {
                    ...
                    Array.isArray(input) ||
                    typeof input === "number" ||
                    ((ref = global.Buffer) != null ? ref.isBuffer(input) : void 0)
                  ) {
            ...
            M4ADemuxer = (function (superClass) {
              ...
              M4ADemuxer.prototype.parseChapters = function () {
                ...
                while (this.chapters.length < track.seekPoints.length) {
                  ...
                  nextTimestamp =
                    (ref2 = (ref3 = track.seekPoints[this.chapters.length + 1]) != null ? ref3.timestamp : void 0) != null
                      ? ref2
                      : track.duration;
                  this.chapters.push({
                    title: title,
    ...
    return this.outputBuffer;";
      ...
      27: [
        ...
        {"./asset": 1, "./core/events": 8, "./device": 20, "./filters/balance": 25, "./filters/volume": 26, "./queue": 28},
      ],
      28: [
        function (require, module, exports) {
          // Generated by CoffeeScript 1.10.0
